...
export function Gallery() {
  return (
    <section id="gallery" className="scroll-mt-20 bg-mauve-50 py-24 sm:py-32">
      <div className="container-page">
        <SectionHeading
          eyebrow="The Space"
          title="A room that lets you exhale"
          description="Soft light, natural materials, and quiet corners. Here's a glimpse before you arrive."
        />

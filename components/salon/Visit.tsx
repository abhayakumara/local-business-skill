...
export function Visit() {
  return (
    <section id="visit" className="scroll-mt-20 bg-ivory py-24 sm:py-32">
      <div className="container-page">
        <SectionHeading
          align="left"
          eyebrow="Find Us"
          title="Come and visit"
          description="We're tucked just off the main street, with the kettle on and a chair waiting."
        />
            ...
            <div className="flex h-full flex-col gap-8 rounded-4xl bg-white p-8 shadow-soft sm:p-10">
              <InfoRow icon={<MapPinIcon />} label="Address">
                <a
                  ...
                  className="hover:text-mauve-600"
                >
              ...
              <div className="grid grid-cols-1 gap-4 border-t border-ink/10 pt-6 sm:grid-cols-2">
                ...
                <InfoRow icon={<MailIcon />} label="Email" compact>
                  <a
                    ...
                    className="break-all hover:text-mauve-600"
                  >
                    {business.email}
                  </a>
                </InfoRow>
...
function InfoRow({
  ...
  return (
    <div className="flex gap-4">
      <span className="mt-0.5 flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-mauve-50 text-mauve-600">
        {icon}
      </span>

import { business, services, faqs } from '@/content/salon';
import { siteUrl } from '@/lib/site';

// JSON-LD for local SEO: BeautySalon + service catalog + FAQ. Rendered
...
export function StructuredData() {
  ...
  const salon = {
    ...
    image: `${siteUrl}/images/salon/og-image.svg`,
    address: {
      '@type': 'PostalAddress',
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify(salon) }}
      />
      <script
        type="application/ld+json"

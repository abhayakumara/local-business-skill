              ...
              <div key={faq.id}>
                <h3>
                  ...
                  >
                    ...
                    <span
                      className={`flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-forge-50 text-forge-600 transition-transform duration-300 ${
                        isOpen ? 'rotate-45' : ''
                      }`}
                      aria-hidden
                    >

...
export function Visit() {
  return (
    <section id="visit" className="scroll-mt-20 bg-concrete py-24 sm:py-32">
      <div className="container-page">
        <SectionHeading
          align="left"
          eyebrow="Find Us"
          title="Come train with us"
          description="Easy to reach, with free parking, full changing rooms, and showers on site."
        />
...
function InfoRow({
  ...
  return (
    <div className="flex gap-4">
      <span className="mt-0.5 flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-forge-50 text-forge-600">
        {icon}
      </span>

    ...
    <section id="visit" className="scroll-mt-20 bg-cream py-24 sm:py-32">
      <div className="container-page">
        <SectionHeading
          ...
          description="We're in the heart of the neighbourhood, with the door open and the tandoor lit."
        />
        ...
        <div className="mt-14 grid gap-8 lg:grid-cols-5">
          ...
          <Reveal className="lg:col-span-2">
            <div className="flex h-full flex-col gap-8 rounded-4xl bg-white p-8 shadow-soft sm:p-10">
              ...
              <div className="grid grid-cols-1 gap-4 border-t border-charcoal/10 pt-6 sm:grid-cols-2">
                ...
                <InfoRow icon={<MailIcon />} label="Email" compact>
                  <a
                    ...
                    className="break-all hover:text-saffron-600"
                  >
                    {business.email}
                  </a>
                </InfoRow>
...
function InfoRow({
  ...
  return (
    <div className="flex gap-4">
      <span className="mt-0.5 flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-saffron-50 text-saffron-600">
        {icon}
      </span>

      ...
      >
            ...
            <li key={l.href}>
              <a
                ...
                className={`text-sm font-medium transition-colors hover:text-saffron-500 ${
                  scrolled ? 'text-charcoal/80' : 'text-white/90 drop-shadow'
                }`}
              >
                {l.label}
              </a>
        ...
        <div className="flex items-center gap-3 md:hidden">
          <a
            ...
            className={`rounded-full p-2 ${scrolled ? 'text-charcoal' : 'text-white'}`}
          ...
          {links.map((l) => (
            <li key={l.href}>
              <a
                ...
                className="block rounded-xl px-4 py-3 text-base font-medium text-charcoal/80 hover:bg-saffron-50 hover:text-saffron-700"
              >
                {l.label}
              </a>
            </li>

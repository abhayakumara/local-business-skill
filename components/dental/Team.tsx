...
import { team } from '@/content/dental';
    ...
    <section id="team" className="scroll-mt-20 py-24 sm:py-32">
      <div className="container-page">
        <SectionHeading
          ...
          description="A friendly, highly qualified team who genuinely care about your comfort — and remember your name every visit."
        />
              ...
              <article className="group flex flex-col">
                <div className="relative aspect-[3/4] overflow-hidden rounded-3xl shadow-soft">
                  ...
                  <div className="absolute inset-x-0 bottom-0 p-4 text-white">
                    <p className="text-xs font-medium uppercase tracking-wide text-mint-200">
                      {member.specialty}
                    </p>
                  </div>
                </div>
